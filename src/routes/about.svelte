...
<div
	...
	<div class="flex flex-col justify-center items-start max-w-2xl mb-16">
		<div class="flex flex-col pr-8">
			...
			<h2 class="mb-4">
				This is my first web application built on Sveltekit.<br/>
				I am a data analyst currently working at <a href="https://www.tbwa.com.sg/"><strong>TBWA\</strong></a> an advertising agency.
			</h2>
			<h3 class="mb-4">
